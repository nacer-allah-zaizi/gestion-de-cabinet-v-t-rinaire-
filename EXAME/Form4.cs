...
namespace EXAME
{
    public partial class Form4 : Form
    {
        ...
        private void guna2GradientButton1_Click(object sender, EventArgs e)
        {
            ...
            if (!nom.Equals("") && !prenom.Equals("") && !tel.Equals("") && !email.Equals("") && !password.Equals("") && !service.Equals(""))
            {
            ...
            {
                conn.Open();
                string sql1 = "INSERT INTO exam.employe(nom,prenom,tel,email,pw,service) VALUES('" + nom + "','" + prenom + "','" + tel + "','" + email + "','" + password + "','" + service + "');";
                MySqlCommand cmd1 = new MySqlCommand(sql1, conn);
                cmd1.ExecuteNonQuery();
                MessageBox.Show("employe a ete ajoute");
                conn.Close();
                /////////////////
                conn.Open();
                string sql5 = "INSERT INTO exam.utilisateur(email,pw,role) VALUES('"+ email + "','" + password + "','" + service + "');";
            ...
            public void actauliser()
        {
            ...
            conn.ConnectionString = connstring;
            conn.Open();
            string sql3 = "select * from employe";
            MySqlCommand cmd3 = new MySqlCommand(sql3, conn);

            MySqlDataReader dr3 = cmd3.ExecuteReader();
            while (dr3.Read())
            {
                guna2DataGridView1.Rows.Add(dr3["ID"], dr3["NOM"], dr3["PRENOM"], dr3["TEL"], dr3["EMAIL"], dr3["PW"], dr3["SERVICE"]);
            }
        ...
        private void guna2DataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 8)
            {
                ...
                if (MessageBox.Show("etes vous sur de cette suppression ?", "Information", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Information) == DialogResult.Yes)
                {
                    ...
                    string sql4 = "delete from employe where id=" + i + "";
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            conn.ConnectionString = connstring;
            conn.Open();
            string sql3 = "update  exam.employe SET nom ='" + textBox1.Text + "',prenom='" + textBox2.Text + "',tel='" + textBox3.Text + "',email='" + textBox4.Text + "',pw= '" + textBox5.Text + "',service='" + comboBox1.Text + "' where id =" + idd + ";";
            MySqlCommand cmd3 = new MySqlCommand(sql3, conn);
            MySqlDataReader dr3 = cmd3.ExecuteReader();
            conn.Close();
            ///////////////////////////
            ...
            conn.Open();
            string sql4 = "update  exam.utilisateur SET email ='" + textBox4.Text + "',pw='" + textBox5.Text + "',role='"+ comboBox1.Text + "' where email ='" + ee + "' and pw='"+ p + "';";
            MySqlCommand cmd4 = new MySqlCommand(sql4, conn);
            MySqlDataReader dr4 = cmd4.ExecuteReader();
            conn.Close();
            ///////////////////////
            
                    MessageBox.Show("modification termene");
                    actauliser();

                   ////////////////
                    MailMessage mail = new MailMessage("Veterinaire18@gmail.com", textBox4.Text, "Code de connexion", "WELCOME TO OUR APPLICATION WE ARE SO SORRY TO DISTURB YOU ;BUT YOUR CODE HAS CHANGED SO HERE IS YOUR NEW  CODE : " + textBox5.Text);
                    SmtpClient client = new SmtpClient("smtp.gmail.com");
                    client.Port = 587;
                    client.Credentials = new System.Net.NetworkCredential("Veterinaire18@gmail.com", "zzslynbrdezwhzju");
                    client.EnableSsl = true;
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            if (guna2DataGridView1.SelectedRows.Count > 0)
            {
                ...
                var output = new FileStream("C:\\Users\\ORIGINAL SHOP\\Desktop\\employes.pdf", FileMode.Create);
                var writer = PdfWriter.GetInstance(doc, output);

                doc.Open();

                Paragraph paragraph = new Paragraph("employe N°");
